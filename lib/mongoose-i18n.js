(function() {
  'use strict';
  var Document, exports, mongoose, removePathFromSchema, translateObject, _;
  ...
  translateObject = function(object, schema, translation) {
    ...
    return schema.eachPath(function(path, config) {
      var child, index, keys, tree, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _results;
      if (config.options.i18n && !new RegExp("^" + lastTranslatedField + "\\.[^\.]+?$").test(path)) {
        ...
        if (_.isArray(tree)) {
          ...
          for (index = _i = 0, _len = tree.length; _i < _len; index = ++_i) {
            child = tree[index];
            _results.push(tree[index][keys[0]] = (_ref = (_ref1 = tree[index][keys[0]]) != null ? _ref1[translation] : void 0) != null ? _ref : (_ref2 = tree[index][keys[0]]) != null ? _ref2[schema.options.defaultLanguage] : void 0);
          }
          return _results;
        } else {
          return tree[keys[0]] = (_ref3 = (_ref4 = tree[keys[0]]) != null ? _ref4[translation] : void 0) != null ? _ref3 : (_ref5 = tree[keys[0]]) != null ? _ref5[schema.options.defaultLanguage] : void 0;
        }
      }
    });
  };
